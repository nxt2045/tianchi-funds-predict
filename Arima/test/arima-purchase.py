...
purchase_arima_model = sm.tsa.ARIMA(purchase_data1403to1407.astype('float64'), [purchase_p, purchase_d, purchase_q]).fit()
...
# 预测8月
purchase_predict_diff = purchase_arima_model.predict('2014-08-01', '2014-08-31', dynamic=False)
...
text_file.write('purchase(arima) p:%d d:%d q:%d time:%f score:%f' % (
    purchase_p, purchase_d, purchase_q, end - start, purchase_score))
text_file.write('\n')
text_file.close()
